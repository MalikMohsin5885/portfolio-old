  ...
  return (
    <div
      className={`w-full mx-auto  fixed top-0 py-5 sm:py-4 z-30 ${
        scrollPosition > 0 ? `backdrop-blur-2xl` : "bg-transparent"
      } `}
    >
      <nav className=" container m-auto flex items-center justify-between">
        <div data-aos="fade-down" className="logo">
          <Link
            ...
            to="/"
            className="text-3xl text-mine-shaft font-bold sm:text-3xl"
          >
            Mohsin Rasheed
          </Link>
        </div>
            ...
            {navItems.map((item) => (
              ...
              >
                <a
                  ...
                  href={`#${item.name}`}
                  className={`uppercase cursor-pointer text-black hover:text-yellow-500 font-bold ${
